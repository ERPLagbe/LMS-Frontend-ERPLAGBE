...
export default function FeatureCardTwo({ feature }) {
  return (
    <div
      className={`features__item-4 fade-slide ${feature.animation.name} text-center bg-green`}
    ...
    >
      ...
      <div className="thumb">
        {feature.image && (
          <Image className="main-img" src={feature.image} alt="img" />
        )}
        {feature.shapeOne && (
          <Image
            className="animate-img-4 moveBottom"
      ...
      {feature.shapeTwo && (
        <Image
          className="animate-img-top-left rotate"
