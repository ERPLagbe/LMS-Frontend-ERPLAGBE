          ...
          <div className="courseDetails__comment-item">
            {commentItem.image && (
              <div className="courseDetails__left">
                <Image src={commentItem.image} alt="Review" />
              </div>
            )}
            <div className="courseDetails__right">
              ...
              {commentItem.reviewImage && (
                <Image src={commentItem.reviewImage} alt="Icon" />
              )}
              ...
              {commentItem.replyBtn && (
                <Link
                  ...
                  href={commentItem.replyBtn.link ?? "#"}
                >
                  <Image
          ...
          {commentItem.replies &&
            commentItem.replies.map((reply, index) => (
              ...
              >
                {reply.image && (
                  <div className="courseDetails__left">
                    {reply.image && <Image src={reply.image} alt="Review" />}
                  </div>
                )}
                <div className="courseDetails__right">
                  {reply.date && (
                  ...
                  {reply.reviewImage && (
                    <Image src={reply.reviewImage} alt="Icon" />
                  )}
                  {reply.description && (
                    <p className="courseDetails__comment-text">
                      {reply.description}
                  ...
                  {reply.btn && (
                    <Link
                      ...
                      href={reply.btn.link ?? "#"}
                    >
                      <Image src={reply.btn.icon} alt="Icon" />
                      {reply.btn.text}
                    </Link>
                  )}
                </div>
